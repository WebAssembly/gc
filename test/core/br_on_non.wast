(module
  ...
  (func (export "init") (param $x externref)
    ...
    (table.set (i32.const 2) (struct.new (i32.const 6) (rtt.canon $st)))
    (table.set (i32.const 3) (array.new (i32.const 5) (i32.const 1) (rtt.canon $at)))
  ...
  (func (export "br_on_non_data") (param $i i32) (result i32)
    (block $l (result anyref)
      ...
      (block $l2 (param dataref) (result (ref $st))
        ...
        (return (array.get_u (i32.const 0)))
      )
      (return (struct.get_s 0))
    )
    (return (i32.const -1))
  )
