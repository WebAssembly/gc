(module
  ...
  (func (export "init")
    ...
    (table.set (i32.const 5) (struct.new_default (rtt.canon $st)))
    (table.set (i32.const 6) (struct.new_default (rtt.canon $st)))
    (table.set (i32.const 7) (array.new_default (i32.const 0) (rtt.canon $at)))
    (table.set (i32.const 8) (array.new_default (i32.const 0) (rtt.canon $at)))
